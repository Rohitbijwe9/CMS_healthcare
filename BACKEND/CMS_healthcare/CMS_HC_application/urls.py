...
from CMS_HC_application.views import ContactAPIView,AppointmentAPIView,CheckAppointmentStatus,CheckApproveAppointment,CheckPendingAppointment,ApproveAppointmentView,DeleteAppointmentView
