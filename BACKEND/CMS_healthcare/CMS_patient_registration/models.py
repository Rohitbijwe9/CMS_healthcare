...
class Patient(models.Model):
    ...
    patient_marital_status = models.CharField(max_length=20,choice=MARITAL_STATUS,default='unmarried')
...
class Claim(models.Model):
    ...
    doctor_mobile_no = models.PhoneNumberField(regin='IN')
    ...
    room_category = models.OneToOneField(RoomCategory, on_delete=models.CASCADE, blank=True)
