  ...
  useEffect(() => {
    async function fetchData() {
      try {
        ...
        // Make an authenticated request to get the approved appointments
      ...
      <div className="Login container text-center form-container">
        ...
        <table className='table table-stripped table-dark'>
          ...
          <tbody>
            {user.map(obj => {
              return (
                <tr key={obj.appointment_identifier}>
                  ...
                  <td>
                    <NavLink to={`/deleteappointment/${obj.appointment_identifier}/`}>
                      <button className='btn text-danger'><i className="bi bi-archive-fill"></i></button>
                    </NavLink>
                  </td>
                </tr>
              );
